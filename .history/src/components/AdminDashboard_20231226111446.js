...
const Content = styled.div`
  ...
  @media (min-width: 769px) {
    padding-right: 250px; /* Adjust based on the width of SidebarContainer */
    padding-bottom: 60px; /* Adjust for BottomNav height */
  }
`;
...
const SidebarContainer = styled.div`
  @media (min-width: 769px) {
    ...
    overflow-y: auto; /* Allow sidebar to scroll if content is longer than the viewport */
    margin-bottom: -100vh; /* Adjust based on the height of your footer */
  }
`;
