...
import { Flex, ChakraProvider } from '@chakra-ui/react'; // Import ChakraProvider
...
const ManageStudents = () => {
  ...
  useEffect(() => {
    // Replace this with your actual API endpoint and data fetching logic
    const fetchStudents = async () => {
      try {
        // Use the mockStudents data for demonstration purposes
  ...
  return (
    <ChakraProvider> {/* Wrap your component with ChakraProvider */}
      <Box>
        ...
        <Table variant="simple" fontFamily="body"> {/* Apply Chakra UI font style */}
          <Thead>
            <Tr>
              <Th>SN</Th>
