...
const ManageStudents = () => {
  ...
  return (
    <Box>
      ...
      <Button
  variant="ghost"
  colorScheme="yellow" // Use the brown color scheme, if available in your Chakra UI theme
  onClick={openModal}
  borderColor="brown.500" // Set the border color to brown
>
  Upload Students
</Button>


  <Flex justifyContent="flex-end" flex="1"> {/* Set flex="1" to make it extend */}
    <Input
      type="text"
