      ...
      <Table>
        <thead>
          <tr>
            ...
            <ShorterTd onClick={() => handleSort('academic level')}>Level</ShorterTd>
            <Th onClick={() => handleSort('email address')}>Email</Th>
            <WiderTd onClick={() => handleSort('phone number')}>Phone</WiderTd>
          </tr>
        </thead>
        <tbody>
