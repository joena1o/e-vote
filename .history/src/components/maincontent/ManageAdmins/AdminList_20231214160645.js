      ...
      <div>
        ...
        <Modal isOpen={showModal} onClose={handleModalClose}>
          ...
          <ModalContent>
            ...
            <ModalCloseButton />
            <ModalBody>
              {/* Content for adding entries (Add your form elements here) */}
              {/* For example, you can add input fields, select dropdowns, etc. */}
              {/* For simplicity, I'm not adding the form elements here */}
            </ModalBody>
            <ModalFooter>
