...
const ViewResults = () => {
  ...
  const [isLargerThan768, isLargerThan1024, isLargerThan1280] = useMediaQuery([
    '(min-width: 768px)',
    '(min-width: 1024px)',
    '(min-width: 1280px)',
  ]);
  ...
  const cardsToDisplay = isLargerThan1280 ? 4 : isLargerThan1024 ? 3 : 1;
  ...
  const cardHeight = isLargerThan768 ? 'auto' : '400px'; // Increase the height for better visibility on small screens
