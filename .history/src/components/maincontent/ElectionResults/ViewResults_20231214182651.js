...
const ViewResults = () => {
  ...
  // Pagination
  const itemsPerPage = isLargerThan768 ? 6 : 4;
  ...
  return (
    <Box p={4} bg="white" maxH="80vh" overflowY="auto" pb="40px">
      ...
      <Wrap spacing={4}>
        {currentResults.map((election) => (
          <WrapItem key={election.id} flex="1" minW={isLargerThan768 ? 'calc(33.333% - 8px)' : '100%'}>
