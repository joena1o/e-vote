...
import { Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton, Input, FormControl, FormLabel, Box, Table, Thead, Tbody, Tr, Th, Td, VStack, useColorMode } from '@chakra-ui/react';
...
const CreateElection = () => {
  ...
  const electionTypeOptions = [
    ...
    { value: 'hall', label: 'Hall' }, // Add 'Hall' as an option
  ];
