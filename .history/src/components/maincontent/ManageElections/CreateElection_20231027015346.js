...
const CreateElection = () => {
  ...
  const electionTypeOptions = [
    ...
    { value: 'hall', label: 'Hall' }, // Added 'hall' option
  ];
  ...
  const handleManageElection = (election) => {
    // Implement logic to manage the election here
    console.log(`Managing election: ${election.electionTitle}`);
  };
  ...
  const mockElections = [
    {
      ...
      startDate: '2023-10-31T08:00', // Sample date and time
