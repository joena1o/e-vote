      ...
      <Modal isOpen={modalIsOpen} onClose={() => setModalIsOpen(false)} size="md">
        ...
        <ModalContent>
          ...
          <ModalBody as="form" onSubmit={formik.handleSubmit}>
            ...
            <FormControl>
              <FormLabel>
                <FiCalendar /> Nomination Start Date:
              </FormLabel>
              <Input
            ...
            <FormControl>
              <FormLabel>
                <FiCalendar /> Nomination End Date:
              </FormLabel>
              <Input
            ...
            {(electionType === 'faculty' || electionType === 'department') && (
              <FormControl>
                <FormLabel>
                  <FiClipboard /> {electionType.charAt(0).toUpperCase() + electionType.slice(1)} Name:
                </FormLabel>
                <Input
                  name="name"
                  type="text"
            ...
            <Flex justify="space-between">
              <FormControl>
                <FormLabel>
                  <FiCalendar /> Election Start Date:
                </FormLabel>
                <Input
                  name="startDate"
                  type="date"
