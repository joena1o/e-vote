              ...
              <FormControl width="100%">
                ...
                <Box width="100%">
                  <Select
                    ...
                    value={electionTypeOptions.find((option) => option.value === formik.values.electionType)}
              ...
              <FormControl width="100%">
                ...
                <Select
                  ...
                  onChange={(selectedOptions) => {
                    formik.setFieldValue('positions', selectedOptions ? selectedOptions.map((option) => option.value) : []);
                  }}
                  value={positions.filter((position) => formik.values.positions.includes(position.value))}
              ...
              <FormControl width="100%">
                ...
                <Box width="100%">
                  <Select
                    ...
                    value={students.filter((student) => formik.values.committeeMembers.includes(student.value))}
