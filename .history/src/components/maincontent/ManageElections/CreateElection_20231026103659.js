...
import { 
  FiCalendar, FiUsers, FiFileText, FiUserCheck, FiClipboard, FiType 
} from 'react-icons/fi';
...
const CreateElection = () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      name: '',
      startDate: '',
      positions: [], // Modified to be an array
      committeeMembers: [],
      endDate: '',
    },
    validationSchema: Yup.object({
      ...
      positions: Yup.array().min(1, 'At least one position must be selected').required('Required'),
              ...
              <FormControl id="positions">
                ...
                <Box width="100%">
                  <Select
                    ...
                    value={positionsList.filter(position =>
