      ...
      <Modal isOpen={modalIsOpen} onClose={() => setModalIsOpen(false)} size="md">
        ...
        <ModalContent>
          ...
          <ModalBody as="form" onSubmit={formik.handleSubmit}>
            {/* Form elements */}
            <FormControl>
              <FormLabel><FiType /> Election Title:</FormLabel>
              <Input
                name="electionTitle"
                type="text"
            ...
            <FormControl>
              <FormLabel><FiFileText /> Election Type:</FormLabel>
              <Box width="100%">
                <Select
                  name="electionType"
            ...
            <FormControl>
              <FormLabel><FiCalendar /> Nomination Start Date:</FormLabel>
              <Input
            ...
            <FormControl>
              <FormLabel><FiCalendar /> Nomination End Date:</FormLabel>
              <Input
            ...
            <Flex justify="space-between">
              <FormControl>
                <FormLabel><FiCalendar /> Election Start Date:</FormLabel>
                <Input
                  name="startDate"
                  type="date"
                  onChange={formik.handleChange}
              ...
              <FormControl>
                <FormLabel><FiCalendar /> Election End Date:</FormLabel>
                <Input
                  name="endDate"
                  type="date"
                  onChange={formik.handleChange}
