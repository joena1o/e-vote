...
const CreateElection = () => {
  ...
  const students = [
    { value: 'Pascal@example.com', label: 'John Doe' },
    { value: 'Prisca@example.com', label: 'Jane Smith' },
  ];
      ...
      <Form onSubmit={formik.handleSubmit}>
        ...
        <Row>
          <HalfWidthField>
            ...
            />
            {formik.errors.electionTitle && <div>{formik.errors.electionTitle}</div>}
          </HalfWidthField>
          ...
          <HalfWidthField>
            ...
            />
            {formik.errors.electionType && <div>{formik.errors.electionType}</div>}
          </HalfWidthField>
        </Row>
        ...
        {/* Assuming committeeMembers is a multiselect, hence handling it differently */}
        <FormField>
          <FormLabel>
            <FiUserCheck />
            Committee Members:
