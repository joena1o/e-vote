...
const StyledLink = styled(Link)`
  ...
  &:hover {
    color: #fce364; // Set the hover color for text

    ${Icon} { // Set the hover color for icon when the parent StyledLink is hovered
      color: #fce364;
    }
  }
...
const Icon = styled.div`
  ...
  margin-bottom: 5px;
  transition: color 0.3s ease; // Ensure the color transition for the icon is smooth
`;
